...
/**
 * 
 * @TableName user_competition_description
 */
@TableName(value ="user_competition_description")
@Data
public class UserCompetitionDescription implements Serializable {
    /**
     * 主键
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        UserCompetitionDescription other = (UserCompetitionDescription) that;
